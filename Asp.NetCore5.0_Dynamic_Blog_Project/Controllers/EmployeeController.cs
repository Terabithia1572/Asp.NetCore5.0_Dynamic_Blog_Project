...
namespace Asp.NetCore5._0_Dynamic_Blog_Project.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                var responseMessage = await client.GetAsync("https://localhost:44396/api/Default");
        ...
        public async Task<IActionResult> AddEmployee(EmployeeVM employee)
        {
            using (var client = new HttpClient())
            {
                ...
                var responseMessage = await client.PostAsync("https://localhost:44396/api/Default", content);
